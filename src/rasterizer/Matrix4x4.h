...
public:
  ...
  const Matrix4x4 operator*(const Matrix4x4 &) const;//TODO
  const sivelab::Vector3D multVector(const sivelab::Vector3D &v, const double w) const;//TODO

  double det(void) const;//TODO
